"""
Django settings for EliteNotes project.
...
SECRET_KEY = '8-ru$yq&pc$eh-f^4%!@#(huwhh_1$!ek5t^_u_q979@5@i^jl'
...
ROOT_URLCONF = 'EliteNotes.urls'

WSGI_APPLICATION = 'EliteNotes.wsgi.application'
